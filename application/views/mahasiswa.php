<div class="content-wrapper">
    <section class="content">
        ...
        <!-- <a class="btn btn-warning" href="<?php echo base_url('mahasiswa/pdf1')?>"><i class="fa fa-print">EXPORT PDF </i></a> -->
        ...
        <!-- <div class="dropdown d-inline">
            ...
            <a class="btn btn-info" href="<?php echo base_url('mahasiswa/tampil_grafik') ?>"><i
                    class="fa fa-chart-area"> Grafik </i></a>


        <div class="navbar-from">
            <?php echo form_open('mahasiswa/search')?>
            <input type ="text" name="keyword" class="from" placeholder="Search">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo form_open_multipart('mahasiswa/tambah_aksi') ?>
                        ...
                        <div class="form-group">
                            <label>no_telp</label>
                            <input type="text" name="no_telp" class="form-control datepicker">
                        </div>
                        <div class="form-group">
